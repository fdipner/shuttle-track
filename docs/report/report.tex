...
% ETHASL package
% Choose options according to your project
...
\title{Perception for playing badminton with a quadruped}
%\subtitle{bla bla bla}

\studentA{Florentin Dipner}

\supervisionA{Dr. Andrei Cramariuc}
\supervisionB{William Talbot}
\supervisionC{Turcan Tuna}
...
\clearpage
\input{chapters/declaration_generative_ai}\clearpage % Comment line if "no generative AI" was selected in declaration
